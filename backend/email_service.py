...
def send_otp_email(to_email: str, username: str, otp: str):
    subject = f"Your ParkSmart Login Code: {otp}"
    html = f"""
    <div style="font-family:Arial,sans-serif;background:#0a0e1a;padding:40px;">
      <div style="max-width:480px;margin:0 auto;background:#111827;border:1px solid #1e2d45;border-radius:16px;overflow:hidden;">
        <div style="background:linear-gradient(90deg,#00d4ff,#4d7cfe);height:4px;"></div>
        <div style="padding:36px;text-align:center;">
          <div style="font-size:32px;margin-bottom:8px;">🔐</div>
          <h1 style="font-size:20px;font-weight:800;color:#e8edf5;margin:0 0 6px;">
            Your Login Code
          </h1>
          <p style="color:#5a6a84;font-size:13px;margin:0 0 28px;">
            Hi <strong style="color:#00d4ff;">{username}</strong>, use this OTP to complete your login.
          </p>
          <div style="background:#0a0e1a;border:2px solid #00d4ff;border-radius:16px;padding:24px;margin-bottom:24px;">
            <div style="font-size:42px;font-weight:900;color:#00d4ff;letter-spacing:12px;font-family:monospace;">
              {otp}
            </div>
            <p style="color:#5a6a84;font-size:12px;margin:12px 0 0;">
              Valid for <strong style="color:#ffd600;">5 minutes</strong> only
            </p>
          </div>
          <p style="color:#5a6a84;font-size:12px;line-height:1.6;">
            If you didn't request this, please ignore this email.<br/>
            Never share this code with anyone.
          </p>
        </div>
        <div style="padding:16px 36px;border-top:1px solid #1e2d45;">
          <p style="color:#5a6a84;font-size:11px;margin:0;text-align:center;">
            © 2025 ParkSmart · AI-Powered Parking
          </p>
        </div>
      </div>
    </div>

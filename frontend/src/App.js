...
function NearbyLots({ onBook, username, stats }) {
        ...
        {tab === "dashboard" && (
          <div className="page">
            <div className="stats-row">
              {[
                { c: "#00d4ff", icon: "🅿️", label: "Total Slots", val: stats.total_slots, sub: "Across 4 zones" },
            ...
            <div className="dashboard-body">
              ...
              <div className="dashboard-right">
                ...
                {/* NEARBY LOTS PANEL */}
                <NearbyLots onBook={() => setTab("booking")} username={username} stats={stats} />
              </div>
            </div>
          </div>
        )}

        ...
        <div className="nlm-overlay" onClick={() => setShowHelpDetail(null)}>
          <div className="nlm-modal" style={{ maxWidth: 400 }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ borderTop: "1px solid var(--border)", paddingTop: 14, marginTop: 8, display: "flex", gap: 10 }}>
              ...
              <a
                href={`mailto:chananadaksh14@gmail.com?subject=ParkSmart Help: ${showHelpDetail.title}&body=Hi ParkSmart Support,%0A%0AI need help with: ${showHelpDetail.title}%0A%0A[Describe your question here]%0A%0AUsername: ${username}`}
                style={{
                  flex: 1, display: "flex", alignItems: "center", justifyContent: "center",
                  gap: 6, padding: "10px", borderRadius: 10, textDecoration: "none",
            ...
            <div style={{ position: "relative" }}>
              ...
              {showHelpPanel && (
                <div style={{
                  ...
                  <div style={{ padding: "10px 16px", textAlign: "center" }}>
                    <a
                      href={`mailto:chananadaksh14@gmail.com?subject=ParkSmart Support Request&body=Hi ParkSmart Support Team,%0A%0AI need help with:%0A%0A[Describe your issue here]%0A%0AUsername: ${username}%0ADate: ${new Date().toLocaleDateString("en-IN")}`}

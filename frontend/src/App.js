      ...
      <div className="nl-list">
        {NEARBY_LOTS.map(lot => (
          <div
            ...
            onClick={() => lot.available > 0 && setSelected(selected === lot.id ? null : lot.id)}
          >
            ...
            {selected === lot.id && (
              <div className="nl-expanded">
                <div className="nl-details-row">
                  <span>Total Spots</span><span>{lot.total}</span>
                </div>
                <div className="nl-details-row">
                  <span>Available</span><span style={{ color: "#00e676" }}>{lot.available}</span>
                </div>
                <div className="nl-details-row">
                  <span>Rate</span><span>₹{lot.rate}/hr</span>
                </div>
                {lot.highlight ? (
                  <button className="nl-book-btn" onClick={onBook}>Book This Lot →</button>
                ) : (
                  <div className="nl-coming-soon">Booking coming soon for this lot</div>
                )}
              </div>
            )}
          </div>
          ...
          <div className="page">
            ...
            <div className="dashboard-body">
              ...
              <div className="dashboard-right">
                ...
                {/* NEARBY LOTS PANEL */}
                <NearbyLots onBook={() => setTab("booking")} />
              </div>
            </div>
          </div>
        )}

    ...
    <div className="admin-app">
      ...
      <nav className="admin-nav">
        <div className="admin-nav-left">
          <div className="admin-logo"><img src={parksmartLogo} alt="ParkSmart" style={{ width: 28, height: 28, objectFit: "contain", verticalAlign: "middle", marginRight: 8 }} />Park<span>Smart</span></div>
          ...
          <>
            ...
            <div className="admin-stats-row">
              ...
              <div className="admin-stat" style={{ "--c": "#ff3d5a" }}>
                <div className="admin-stat-icon"><img src={parksmartLogo} alt="ParkSmart" style={{ width: 28, height: 28, objectFit: "contain" }} /></div>
